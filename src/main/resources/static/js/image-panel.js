  ...
  const mockImageData = {
    ...
    "stereo-projection": {
      ...
      images: Array(5)
        .fill(null)
        .map((_, i) => ({
          url: `/image/stereo/image${i + 1}.jpg`,
    ...
    multispectral: {
      ...
      images: Array(5)
        .fill(null)
        .map((_, i) => ({
          url: `/image/multispectral/image${i + 1}.jpg`,
    ...
    thermal: {
      ...
      images: Array(5)
        .fill(null)
        .map((_, i) => ({
          url: `/image/thermal/image${i + 1}.jpg`,
